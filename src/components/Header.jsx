...
import { connectWallet } from '../Kawaki'
  ...
  return (
    <nav className="w-4/5 flex md:justify-center justify-between items-center py-4 mx-auto">
      <div className="flex flex-row justify-start items-center md:flex-[0.5] flex-initial">
        <img className="w-8 cursor-pointer" src={ethlogo} alt="Kawaki Logo" />
        <span className="text-white text-2xl ml-2">Kawaki</span>
      </div>
      ...
      {connectedAccount ? (
        ...
        <button
          className="shadow-xl shadow-black text-white 
        bg-[#990e0e] hover:bg-[#bd2525] md:text-xs p-2
        rounded-full cursor-pointer"
